...
def placement_agent(state:State)->str:
    ...
    try:
        ...
        prompt = f"""
        You are a placement information according user's select college agent that can provide information about college or university placement information. 
        ...
        return {
            "placement_result":response.content
        }

...
def general_agent(state:State)->str:
    ...
    try:
        ...
        prompt = f"""
        You are a general information according user's select college agent that can provide information about college or university general  information like - event , play etc. 
        ...
        return {
            "general_result":response.content
        }

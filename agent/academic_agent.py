...
def academic_agent(state:State)->str:
    ...
    try:
        ...
        prompt = f"""
        You are a syllabus information according user's select college agent that can provide information about college or university syllabus.  
        ...
        return {
                "academic_result":response.content
        }
...
#     final = fees_agent({
#         "user_query_type": "placement",
#         "college_name": "jis college of engineering",
#         "semister": "2nd Semester",
#         "user_query":" what is minmum attendence required for passing the semister."
#     })
#     print(final)